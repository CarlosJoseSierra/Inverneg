...
exports.updateUbicacionById = exports.getUbicacionById = exports.getUbicacion = exports.createNewUbicacion = void 0;
...
var getUbicacion = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          pool = _context.sent;
          _context.next = 6;
          return pool.request().query(_database.querys.getAllUbicacion);
        case 6:
  ...
  return function getUbicacion(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
exports.getUbicacion = getUbicacion;
var createNewUbicacion = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body, UBIC_ciudad, UBIC_provincia, UBIC_USU_ing, pool, result;
  ...
  return function createNewUbicacion(_x3, _x4) {
...
var updateUbicacionById = /*#__PURE__*/function () {
  ...
  return function updateUbicacionById(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
exports.updateUbicacionById = updateUbicacionById;
var getUbicacionById = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 3:
          pool = _context4.sent;
          _context4.next = 6;
          return pool.request().input("id", req.params.id).query(_database.querys.getUbicacionById);
        case 6:
  ...
  return function getUbicacionById(_x7, _x8) {
