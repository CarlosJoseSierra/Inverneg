...
exports.updateSucursalById = exports.getSucursales = exports.getSucursalById = exports.createNewSucursal = void 0;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          pool = _context.sent;
          _context.next = 6;
          return pool.request().query(_database.querys.getAllSucursales);
        case 6:
...
var createNewSucursal = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body, SUC_descripcion, SUC_direccion, SUC_UBIC_id, SUC_USU_ing, pool, result;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _req$body = req.body, SUC_descripcion = _req$body.SUC_descripcion, SUC_direccion = _req$body.SUC_direccion, SUC_UBIC_id = _req$body.SUC_UBIC_id, SUC_USU_ing = _req$body.SUC_USU_ing; // validating
        ...
        case 6:
          pool = _context2.sent;
          _context2.next = 9;
          return pool.request().input("SUC_descripcion", _database.sql.VarChar, SUC_descripcion).input("SUC_direccion", _database.sql.VarChar, SUC_direccion).input("SUC_UBIC_id", _database.sql.Decimal, SUC_UBIC_id).input("SUC_USU_ing", _database.sql.Decimal, SUC_USU_ing).query(_database.querys.addNewSucursal);
        case 9:
  ...
  return function createNewSucursal(_x3, _x4) {
...
var updateSucursalById = /*#__PURE__*/function () {
  ...
  return function updateSucursalById(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
exports.updateSucursalById = updateSucursalById;
var getSucursalById = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 3:
          pool = _context4.sent;
          _context4.next = 6;
          return pool.request().input("id", req.params.id).query(_database.querys.getSucursalById);
        case 6:
  ...
  return function getSucursalById(_x7, _x8) {
