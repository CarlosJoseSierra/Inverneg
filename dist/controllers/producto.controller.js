    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          pool = _context2.sent;
          _context2.next = 7;
          return pool.request().input("PROD_codigo", _database.sql.VarChar, PROD_codigo).input("PROD_codigoExt", _database.sql.VarChar, PROD_codigoExt).input("PROD_descripcion", _database.sql.VarChar, PROD_descripcion).input("PROD_TP_id", _database.sql.Decimal, PROD_TP_id).input("PROD_stockFijo", _database.sql.Decimal, PROD_stockFijo).input("PROD_costoFijo", _database.sql.Decimal, PROD_costoFijo).input("PROD_totalFijo", _database.sql.Decimal, PROD_totalFijo).input("PROD_stockReal", _database.sql.Decimal, PROD_stockReal).input("PROD_costoReal", _database.sql.Decimal, PROD_costoReal).input("PROD_totalReal", _database.sql.Decimal, PROD_totalReal).input("PROD_INV_id", _database.sql.Decimal, PROD_INV_id).input("PROD_USU_ing", _database.sql.Decimal, PROD_USU_ing).input("PROD_BOD_id", _database.sql.Decimal, PROD_BOD_id).input("PROD_linea", _database.sql.VarChar, PROD_linea).query(_database.querys.addNewProducto);
        case 7:
